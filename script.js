class WizmanHeritage {
  constructor() {
    ...
    this.translations = {
      fr: {
        home: 'Accueil', services: 'Services', international: 'International', faq: 'FAQ', about: 'À propos', contact: 'Contact', 'hero-badge': 'Cabinet International • Service Confidentiel', 'hero-title': 'Expertise en Généalogie Successorale', 'hero-description': "Cabinet international de généalogie successorale. Nous identifions les héritiers et sécurisons les droits d'héritage avec discrétion et professionnalisme.", 'cta-button': 'Consultation confidentielle', 'services-title': 'Services Spécialisés', 'service1-title': 'Recherche Successorale', 'service1-desc': 'Identification discrète et complète des héritiers et ayants droit à travers le monde avec méthodes d’investigation avancées.', 'service2-title': 'Documentation Généalogique', 'service2-desc': 'Constitution de dossiers juridiques complets avec preuves documentaires authentifiées et certifiées.', 'service3-title': 'Conseil Juridique Spécialisé', 'service3-desc': 'Accompagnement par des experts en droit successoral international et collaboration avec notaires partenaires.', 'stat1-label': 'Années d’expérience', 'stat2-label': 'Dossiers traités', 'stat3-label': 'Disponible 24/7', 'international-title': 'Présence Internationale', 'france-title': 'France', 'israel-title': 'Israël', 'usa-title': 'États-Unis', 'faq-title': 'Questions Fréquentes', 'faq1-question': 'Comment identifiez-vous les héritiers à l’étranger ?', 'faq1-answer': 'Nous utilisons des méthodes d’investigation documentées avec nos correspondants locaux.', 'faq2-question': 'Mes données sont-elles confidentielles ?', 'faq2-answer': 'Toutes les informations sont traitées selon le RGPD et ne sont jamais partagées sans consentement.', 'faq3-question': 'Puis-je envoyer des documents en toute sécurité ?', 'faq3-answer': 'Oui, les fichiers sont sécurisés et limités à 10MB chacun, conformément à notre politique de confidentialité.', 'about-title': 'Excellence & Discrétion', 'about-desc': 'WizmanHeritage est un cabinet international reconnu pour son expertise en recherche successorale. Nous servons une clientèle internationale avec la plus haute confidentialité, utilisant des méthodes d’investigation rigoureuses et respectant les législations de chaque pays d’intervention.', 'feature1': 'Confidentialité absolue', 'feature2': 'Expertise internationale', 'feature3': 'Résultats garantis', 'contact-title': 'Contact Confidentiel', 'form-name': 'Nom complet', 'form-email': 'Email', 'form-phone': 'Téléphone (optionnel)', 'form-message': 'Votre demande', 'message-placeholder': 'Décrivez votre situation en quelques mots. Toutes les informations resteront strictement confidentielles.', 'form-document': 'Documents (optionnel)', 'file-upload-text': 'Cliquer ou déposer vos documents ici', 'file-upload-hint': 'PDF, Word, Images acceptés (max 10MB chacun)', 'consent-text': 'J’accepte que mes données soient traitées conformément à la politique de confidentialité.', 'privacy-text': 'Vos informations sont traitées avec la plus stricte confidentialité et ne sont jamais partagées avec des tiers.', 'form-submit': 'Envoyer ma demande', 'footer-desc': 'Cabinet spécialisé en généalogie successorale internationale', 'footer-certified': 'Certifié • Confidentiel • International', 'footer-contact-title': 'Contact Professionnel', 'footer-availability': 'Disponible 24/7 pour urgences', 'footer-legal-title': 'Mentions Légales', 'footer-design': 'Conçu par Ruben Wizman', 'footer-compliance': 'Conforme RGPD • Données protégées', 'footer-rights': 'Tous droits réservés.', 'privacy-policy': 'Politique de confidentialité', 'cookie-text': 'Nous utilisons des cookies nécessaires au fonctionnement du site.', 'cookie-accept': 'Accepter', 'cookie-decline': 'Refuser',
        'privacy-page-title': 'Politique de Confidentialité - WizmanHeritage', 'privacy-description': 'Politique de confidentialité de WizmanHeritage. Découvrez comment nous collectons, utilisons et protégeons vos données personnelles.', 'privacy-main-header': 'Politique de Confidentialité', 'privacy-last-updated-label': 'Dernière mise à jour :', 'privacy-date': '18 septembre 2025', 'privacy-intro': 'WizmanHeritage s’engage à protéger vos données personnelles. Cette Politique de Confidentialité décrit comment nous collectons, utilisons, et protégeons les informations que vous nous fournissez via notre site web, conformément au Règlement Général sur la Protection des Données (RGPD).', 'privacy-h2-collection': '1. Collecte des Données Personnelles', 'privacy-p-collection-1': 'Nous collectons des informations lorsque vous utilisez notre formulaire de contact ou interagissez avec notre site. Les données collectées peuvent inclure :', 'privacy-li-collection-name': 'Nom complet : Pour vous identifier.', 'privacy-li-collection-email': 'Adresse email : Pour communiquer avec vous.', 'privacy-li-collection-phone': 'Numéro de téléphone (optionnel) : Pour un contact direct si nécessaire.', 'privacy-li-collection-message': 'Message : Toute information que vous fournissez concernant votre demande.', 'privacy-li-collection-docs': 'Documents : Fichiers que vous téléchargez volontairement pour appuyer votre demande.', 'privacy-li-collection-nav': 'Données de navigation : Telles que les cookies nécessaires au bon fonctionnement du site.', 'privacy-h2-usage': '2. Utilisation de Vos Données', 'privacy-p-usage-1': 'Vos données sont utilisées exclusivement pour :', 'privacy-li-usage-reply': 'Répondre à vos demandes de consultation et fournir nos services de généalogie successorale.', 'privacy-li-usage-manage': 'Gérer et sécuriser notre site web.', 'privacy-li-usage-legal': 'Respecter nos obligations légales et réglementaires.', 'privacy-p-usage-2': 'Nous ne partageons jamais vos données avec des tiers à des fins marketing. Vos informations ne sont transmises qu’avec votre consentement explicite ou si la loi l’exige.', 'privacy-h2-security': '3. Sécurité des Données', 'privacy-p-security-1': 'Nous mettons en œuvre des mesures de sécurité techniques et organisationnelles pour protéger vos données contre tout accès, modification, divulgation ou destruction non autorisés. Les transferts de fichiers sont sécurisés et l’accès à vos informations est strictement limité.', 'privacy-h2-retention': '4. Conservation des Données', 'privacy-p-retention-1': 'Nous conservons vos données personnelles uniquement le temps nécessaire à la réalisation des finalités pour lesquelles elles ont été collectées, ou pour nous conformer à nos obligations légales.', 'privacy-h2-rights': '5. Vos Droits', 'privacy-p-rights-1': 'Conformément au RGPD, vous disposez des droits suivants concernant vos données personnelles :', 'privacy-li-rights-access': 'Droit d’accès : Vous pouvez demander une copie des données que nous détenons sur vous.', 'privacy-li-rights-rectify': 'Droit de rectification : Vous pouvez demander la correction de données inexactes.', 'privacy-li-rights-erase': 'Droit à l’effacement : Vous pouvez demander la suppression de vos données.', 'privacy-li-rights-limit': 'Droit à la limitation du traitement : Vous pouvez demander à ce que nous limitions l’utilisation de vos données.', 'privacy-p-rights-2': 'Pour exercer ces droits, veuillez nous contacter en utilisant le formulaire de contact de notre site.', 'privacy-h2-cookies': '6. Cookies', 'privacy-p-cookies-1': 'Notre site utilise des cookies essentiels à son fonctionnement. Un bandeau de consentement vous permet d’accepter ou de refuser leur utilisation lors de votre première visite.', 'privacy-h2-contact': '7. Contact', 'privacy-p-contact-1': 'Si vous avez des questions concernant cette politique de confidentialité, veuillez nous contacter via le formulaire de contact sur notre site principal.', 'privacy-back-to-home': 'Retour à l’accueil'
      },
      en: {
        home: 'Home', services: 'Services', international: 'International', faq: 'FAQ', about: 'About', contact: 'Contact', 'hero-badge': 'International Firm • Confidential Service', 'hero-title': 'Heir Tracing & Probate Genealogy', 'hero-description': 'International probate genealogy firm. We identify heirs and secure inheritance rights with discretion and professionalism.', 'cta-button': 'Confidential consultation', 'services-title': 'Specialized Services', 'service1-title': 'Heir Research', 'service1-desc': 'Discrete and comprehensive identification of heirs and beneficiaries worldwide using advanced investigation methods.', 'service2-title': 'Genealogical Documentation', 'service2-desc': 'Compilation of complete legal files with authenticated and certified documentary evidence.', 'service3-title': 'Specialized Legal Counsel', 'service3-desc': 'Support by experts in international inheritance law and collaboration with partner notaries.', 'stat1-label': 'Years of experience', 'stat2-label': 'Cases handled', 'stat3-label': 'Available 24/7', 'international-title': 'International Presence', 'france-title': 'France', 'israel-title': 'Israel', 'usa-title': 'United States', 'faq-title': 'Frequently Asked Questions', 'faq1-question': 'How do you identify heirs abroad?', 'faq1-answer': 'We use documented investigation methods with local correspondents.', 'faq2-question': 'Are my data confidential?', 'faq2-answer': 'All information is processed under GDPR and never shared without consent.', 'faq3-question': 'Can I upload files securely?', 'faq3-answer': 'Yes, files are secured and limited to 10MB each, according to our privacy policy.', 'about-title': 'Excellence & Discretion', 'about-desc': 'WizmanHeritage is an international firm renowned for heir research. We serve an international clientele with the utmost confidentiality, using rigorous methods and complying with the laws of each country of operation.', 'feature1': 'Absolute confidentiality', 'feature2': 'International expertise', 'feature3': 'Guaranteed results', 'contact-title': 'Confidential Contact', 'form-name': 'Full name', 'form-email': 'Email', 'form-phone': 'Phone (optional)', 'form-message': 'Your request',
        'message-placeholder': 'Describe your situation in a few words. All information will remain strictly confidential.',
        'form-document': 'Documents (optional)', 'file-upload-text': 'Click or drop your documents here', 'file-upload-hint': 'PDF, Word, Images accepted (max 10MB each)', 'consent-text': 'I consent to my data being processed according to the privacy policy.', 'privacy-text': 'Your information is handled with strict confidentiality and never shared with third parties.', 'form-submit': 'Send my request', 'footer-desc': 'Firm specialized in international probate genealogy', 'footer-certified': 'Certified • Confidential • International', 'footer-contact-title': 'Professional Contact', 'footer-availability': 'Available 24/7 for emergencies', 'footer-legal-title': 'Legal Notice', 'footer-design': 'Designed by Ruben Wizman', 'footer-compliance': 'GDPR compliant • Protected data', 'footer-rights': 'All rights reserved.', 'privacy-policy': 'Privacy policy', 'cookie-text': 'We use cookies necessary for the website to function.', 'cookie-accept': 'Accept', 'cookie-decline': 'Decline',
        'privacy-page-title': 'Privacy Policy - WizmanHeritage', 'privacy-description': 'WizmanHeritage privacy policy. Learn how we collect, use, and protect your personal data.', 'privacy-main-header': 'Privacy Policy', 'privacy-last-updated-label': 'Last updated:', 'privacy-date': 'September 18, 2025', 'privacy-intro': 'WizmanHeritage is committed to protecting your personal data. This Privacy Policy describes how we collect, use, and protect the information you provide via our website, in accordance with the General Data Protection Regulation (GDPR).', 'privacy-h2-collection': '1. Personal Data Collection', 'privacy-p-collection-1': 'We collect information when you use our contact form or interact with our site. The data collected may include:', 'privacy-li-collection-name': 'Full name: To identify you.', 'privacy-li-collection-email': 'Email address: To communicate with you.', 'privacy-li-collection-phone': 'Phone number (optional): For direct contact if necessary.', 'privacy-li-collection-message': 'Message: Any information you provide regarding your request.', 'privacy-li-collection-docs': 'Documents: Files you voluntarily upload to support your request.', 'privacy-li-collection-nav': 'Browsing data: Such as cookies necessary for the site to function properly.', 'privacy-h2-usage': '2. Use of Your Data', 'privacy-p-usage-1': 'Your data is used exclusively to:', 'privacy-li-usage-reply': 'Respond to your consultation requests and provide our probate genealogy services.', 'privacy-li-usage-manage': 'Manage and secure our website.', 'privacy-li-usage-legal': 'Comply with our legal and regulatory obligations.', 'privacy-p-usage-2': 'We never share your data with third parties for marketing purposes. Your information is only shared with your explicit consent or if required by law.', 'privacy-h2-security': '3. Data Security', 'privacy-p-security-1': 'We implement technical and organizational security measures to protect your data from unauthorized access, modification, disclosure, or destruction. File transfers are secured, and access to your information is strictly limited.', 'privacy-h2-retention': '4. Data Retention', 'privacy-p-retention-1': 'We retain your personal data only for the time necessary to fulfill the purposes for which it was collected, or to comply with our legal obligations.', 'privacy-h2-rights': '5. Your Rights', 'privacy-p-rights-1': 'In accordance with the GDPR, you have the following rights regarding your personal data:', 'privacy-li-rights-access': 'Right of access: You can request a copy of the data we hold about you.', 'privacy-li-rights-rectify': 'Right to rectification: You can request the correction of inaccurate data.', 'privacy-li-rights-erase': 'Right to erasure: You can request the deletion of your data.', 'privacy-li-rights-limit': 'Right to restriction of processing: You can ask us to limit the use of your data.', 'privacy-p-rights-2': 'To exercise these rights, please contact us using our website\'s contact form.', 'privacy-h2-cookies': '6. Cookies', 'privacy-p-cookies-1': 'Our site uses cookies that are essential for its operation. A consent banner allows you to accept or decline their use during your first visit.', 'privacy-h2-contact': '7. Contact', 'privacy-p-contact-1': 'If you have any questions about this privacy policy, please contact us via the contact form on our main site.', 'privacy-back-to-home': 'Back to Home'
      },
      he: {
        home: 'דף הבית', services: 'שירותים', international: 'בינלאומי', faq: 'שאלות נפוצות', about: 'אודות', contact: 'יצירת קשר', 'hero-badge': 'משרד בינלאומי • שירות חסוי', 'hero-title': 'מומחיות בגנאלוגיה ירושות', 'hero-description': 'משרד בינלאומי לגנאלוגיה ירושתית. אנו מאתרים יורשים ומבטיחים זכויות ירושה בדיסקרטיות ובמקצועיות.', 'cta-button': 'התייעצות חסויה', 'services-title': 'שירותים מתמחים', 'service1-title': 'חקירת יורשים', 'service1-desc': 'זיהוי דיסקרטי ומקיף של יורשים ומוטבים ברחבי העולם בשיטות חקירה מתקדמות.', 'service2-title': 'תיעוד גנאלוגי', 'service2-desc': 'הכנת תיקי מסמכים משפטיים מלאים עם ראיות מאומתות ומאושרות.', 'service3-title': 'ייעוץ משפטי מומחה', 'service3-desc': 'ליווי ע״י מומחים בדיני ירושה בינלאומיים ושיתוף פעולה עם נוטריונים.', 'stat1-label': 'שנות ניסיון', 'stat2-label': 'תיקים טופלו', 'stat3-label': 'זמינות 24/7', 'international-title': 'נוכחות בינלאומית', 'france-title': 'צרפת', 'israel-title': 'ישראל', 'usa-title': 'ארצות הברית', 'faq-title': 'שאלות נפוצות', 'faq1-question': 'כיצד אתם מזהים יורשים בחו״ל?', 'faq1-answer': 'אנו משתמשים בשיטות חקירה מתועדות בשיתוף פעולה עם נציגים מקומיים.', 'faq2-question': 'האם הנתונים שלי חסויים?', 'faq2-answer': 'כל המידע מטופל בהתאם ל-GDPR ואינו משותף ללא הסכמה.', 'faq3-question': 'האם ניתן לשלוח קבצים בצורה מאובטחת?', 'faq3-answer': 'כן, הקבצים מאובטחים ומוגבלים ל-10MB כל אחד בהתאם למדיניות הפרטיות שלנו.', 'about-title': 'מצוינות ודיסקרטיות', 'about-desc': 'WizmanHeritage הוא משרד בינלאומי בעל מומחיות בחקר יורשים. אנו משרתים לקוחות בכל העולם בסודיות מלאה, בשיטות מחקר קפדניות ובהתאם לדיני כל מדינה.', 'feature1': 'סודיות מוחלטת', 'feature2': 'מומחיות בינלאומית', 'feature3': 'תוצאות מובטחות', 'contact-title': 'יצירת קשר חסויה', 'form-name': 'שם מלא', 'form-email': 'אימייל', 'form-phone': 'טלפון (לא חובה)', 'form-message': 'הפנייה שלך',
        'message-placeholder': 'תאר/י את מצבך בכמה מילים. כל המידע יישאר חסוי לחלוטין.',
        'form-document': 'מסמכים (לא חובה)', 'file-upload-text': 'לחץ או גרור מסמכים לכאן', 'file-upload-hint': 'PDF, Word, תמונות (מקס 10MB כל אחד)', 'consent-text': 'אני מסכים/ה שהנתונים שלי יעובדו בהתאם למדיניות הפרטיות.', 'privacy-text': 'המידע שלך נשמר בסודיות מוחלטת ואינו נמסר לצדדים שלישיים.', 'form-submit': 'שלח את הבקשה', 'footer-desc': 'משרד מומחה בגנאלוגיית ירושות בינלאומית', 'footer-certified': 'מאושר • חסוי • בינלאומי', 'footer-contact-title': 'יצירת קשר מקצועית', 'footer-availability': 'זמינות 24/7 למצבי חירום', 'footer-legal-title': 'מידע משפטי', 'footer-design': 'עיצוב: רובן ויזמן', 'footer-compliance': 'תואם GDPR • נתונים מוגנים', 'footer-rights': 'כל הזכויות שמורות.', 'privacy-policy': 'מדיניות פרטיות', 'cookie-text': 'אנו משתמשים בעוגיות הנדרשות להפעלת האתר.', 'cookie-accept': 'קבל', 'cookie-decline': 'סרב',
        'privacy-page-title': 'מדיניות פרטיות - WizmanHeritage', 'privacy-description': 'מדיניות הפרטיות של WizmanHeritage. למדו כיצד אנו אוספים, משתמשים ומגנים על הנתונים האישיים שלכם.', 'privacy-main-header': 'מדיניות פרטיות', 'privacy-last-updated-label': 'עדכון אחרון:', 'privacy-date': '18 בספטמבר 2025', 'privacy-intro': 'WizmanHeritage מחויבת להגנה על המידע האישי שלך. מדיניות פרטיות זו מפרטת כיצד אנו אוספים, משתמשים ומגנים על המידע הנמסר על ידך באתר האינטרנט שלנו, בהתאם לתקנה הכללית להגנה על מידע (GDPR).', 'privacy-h2-collection': '1. איסוף מידע אישי', 'privacy-p-collection-1': 'אנו אוספים מידע בעת שימושך בטופס יצירת הקשר באתר. המידע הנאסף עשוי לכלול:', 'privacy-li-collection-name': 'שם מלא: לצורך זיהוי.', 'privacy-li-collection-email': 'כתובת דוא"ל: לצורך יצירת קשר.', 'privacy-li-collection-phone': 'מספר טלפון (אופציונלי): ליצירת קשר ישיר במידת הצורך.', 'privacy-li-collection-message': 'הודעה: כל מידע הנמסר על ידך בנוגע לבקשתך.', 'privacy-li-collection-docs': 'מסמכים: קבצים המועלים על ידך באופן וולונטרי לתמיכה בבקשתך.', 'privacy-li-collection-nav': 'נתוני גלישה: כגון קובצי Cookie החיוניים לתפקוד האתר.', 'privacy-h2-usage': '2. שימוש במידע', 'privacy-p-usage-1': 'המידע שלך משמש אותנו אך ורק למטרות הבאות:', 'privacy-li-usage-reply': 'מתן מענה לפניותיך ואספקת שירותי הגנאלוגיה שלנו.', 'privacy-li-usage-manage': 'ניהול ואבטחת אתר האינטרנט.', 'privacy-li-usage-legal': 'עמידה בדרישות משפטיות ורגולטוריות.', 'privacy-p-usage-2': 'איננו חולקים את המידע שלך עם צדדים שלישיים למטרות שיווקיות. המידע יועבר רק בכפוף להסכמתך המפורשת או כנדרש על פי חוק.', 'privacy-h2-security': '3. אבטחת מידע', 'privacy-p-security-1': 'אנו נוקטים באמצעי אבטחה טכניים וארגוניים כדי להגן על המידע שלך מפני גישה, שינוי, חשיפה או השמדה בלתי מורשים. העברת קבצים מאובטחת והגישה למידע מוגבלת באופן מחמיר.', 'privacy-h2-retention': '4. שמירת מידע', 'privacy-p-retention-1': 'המידע האישי שלך יישמר למשך הזמן הדרוש להשגת המטרות שלשמן נאסף, או כפי שנדרש לעמידה בהתחייבויותינו המשפטיות.', 'privacy-h2-rights': '5. זכויותיך', 'privacy-p-rights-1': 'בהתאם ל-GDPR, עומדות לך הזכויות הבאות בנוגע למידע האישי שלך:', 'privacy-li-rights-access': 'זכות עיון: הזכות לבקש עותק של המידע שאנו מחזיקים אודותיך.', 'privacy-li-rights-rectify': 'זכות לתיקון: הזכות לבקש תיקון מידע שאינו מדויק.', 'privacy-li-rights-erase': 'זכות למחיקה: הזכות לבקש את מחיקת המידע שלך.', 'privacy-li-rights-limit': 'זכות להגבלת עיבוד: הזכות לבקש שנגביל את השימוש במידע שלך.', 'privacy-p-rights-2': 'למימוש זכויותיך, ניתן ליצור עמנו קשר באמצעות טופס יצירת הקשר באתר.', 'privacy-h2-cookies': '6. קובצי Cookie', 'privacy-p-cookies-1': 'האתר משתמש בקובצי Cookie החיוניים לתפעולו. באפשרותך לקבל או לדחות את השימוש בהם באמצעות הודעת ההסכמה המופיעה בכניסה לאתר.', 'privacy-h2-contact': '7. יצירת קשר', 'privacy-p-contact-1': 'בכל שאלה הנוגעת למדיניות פרטיות זו, יש ליצור קשר באמצעות טופס יצירת הקשר באתר הראשי.', 'privacy-back-to-home': 'חזרה לדף הבית'
      }
    };
  ...
  // ---------- Email obfuscation (FIX scroll-to-top) ----------
  setupEmailObfuscation() {
    ...
    const buildEmail = (el) => {
      ...
      // 2) data-email-user / data-email-domain / data-email-tld
      ...
      // 3) fallback: texte interne (dernier recours)
      const txt = (el.textContent || '').replace(/\s+/g, '').replace(/\[at\]|\(at\)|\sat\s/gi, '@').replace(/\[dot\]|\(dot\)|\sdot\s/gi, '.');
      return txt.includes('@') ? txt : '';
    };

    const openMailto = (el, evtType = 'click') => {
      ...
      const href = `mailto:${email}${qp.length ? `?${qp.join('&')}` : ''}`;

      // Empêcher le scroll-to-top dû à href="#"
      // Puis naviguer explicitement vers mailto:
    ...
    links.forEach((a) => {
      ...
      a.addEventListener('keydown', (e) => {
        ...
        if (key === 'Enter' || key === ' ') {
          e.preventDefault();
          openMailto(a, 'keydown');
        }
      });

      // Option: rendre le vrai href temporairement pour "copier le lien"
      a.addEventListener('mouseenter', () => {
        ...
        a.setAttribute('href', `mailto:${email}${qp.length ? `?${qp.join('&')}` : ''}`);
      });
  ...
  setupEventListeners() {
    ...
    // >>> Activation de l’obfuscation email (toutes pages)
