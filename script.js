  ...
  constructor() {
    ...
    this.translations = {
      fr: { /* --- FR --- */ 
        ...
        'hero-description': 'Nous identifions les héritiers légitimes et sécurisons leurs droits dans les successions internationales complexes. Service discret, rigoureux et confidentiel.',
        'cta-button': 'Consultation confidentielle',
        'services-title': 'Nos Services en Généalogie Successorale',
        'service1-title': 'Recherche d’Héritiers Successorale',
        ...
        'stat1-label': "Pays d'Intervention",
        'stat2-label': "Confidentialité Garantie",
        'stat3-label': 'Disponible 24/7',
        'international-title': 'Présence Internationale pour vos Successions',
        'france-title': 'France',
        'israel-title': 'Israël',
        'usa-title': 'États-Unis',
        'faq-title': 'Questions Fréquentes sur la Généalogie Successorale',
      ...
      en: { /* --- EN --- */
        ...
        'hero-description': 'We identify rightful heirs and secure their rights in complex cross-border estates. Our service is discrete, rigorous, and confidential.',
        'cta-button': 'Confidential consultation',
        'services-title': 'Our Probate Genealogy Services',
        'service1-title': 'Heir Research for Estates',
        ...
        'stat1-label': "Countries of Operation",
        'stat2-label': "Confidentiality Guaranteed",
        'stat3-label': 'Available 24/7',
        'international-title': 'International Presence for your Estates',
        'france-title': 'France',
        'israel-title': 'Israel',
        'usa-title': 'United States',
        'faq-title': 'Frequently Asked Questions about Probate Genealogy',
      ...
      he: { /* --- HE --- */
        ...
        'hero-title': 'מומחיות בגנאלוגיה של ירושות',
        'hero-description': 'אנו מאתרים יורשים חוקיים ומבטיחים את זכויותיהם בירושות בינלאומיות מורכבות. שירות דיסקרטי, קפדני וחסוי.',
        'cta-button': 'התייעצות חסויה',
        'services-title': 'שירותי גנאלוגיה לירושות',
        'service1-title': 'איתור יורשים לירושות',
        ...
        'stat1-label': 'מדינות פעילות',
        'stat2-label': 'סודיות מובטחת',
        'stat3-label': 'זמינות 24/7',
        'international-title': 'נוכחות בינלאומית לירושות שלכם',
        'france-title': 'צרפת',
        'israel-title': 'ישראל',
        'usa-title': 'ארצות הברית',
        'faq-title': 'שאלות נפוצות בנושא גנאלוגיה של ירושות',
